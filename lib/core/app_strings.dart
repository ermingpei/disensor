...
留存 1000 Q比特 满 30 天，自动升级为先驱合伙人。''',
      ...
      'jackpot_lose': '差一点点！获得 0.1 Q比特安慰奖。\n\n别灰心，大奖还在等你！',
      'item': '商品:',
      'cost': '消耗:',
...
• **先驱 (PRIME)**: 在任意费率基础上额外 +20% 加速。''',
      ...
      'staking_explain_desc':
          '这不仅是一个会员身份，更是点索 (DiSensor) 网络的股东。\n\n当您选择**留存**您的 Q比特时，意味着您看好网络的长期未来。为了回报您的信任，我们赋予您 **20% 的永久加速权**，就像您往存钱罐里多放了一笔定期存款，我们要给您更高的利息。',
